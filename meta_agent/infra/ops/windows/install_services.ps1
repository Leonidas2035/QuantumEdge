...
$botDir = Get-Cfg $cfg "AI_SCALPER_BOT_DIR" "C:\ai_scalper_bot"
$supDir = Get-Cfg $cfg "SUPERVISOR_AGENT_DIR" "C:\SupervisorAgent"
...
$logDir = Get-Cfg $cfg "LOG_DIR" "C:\logs\QuantumEdge"
