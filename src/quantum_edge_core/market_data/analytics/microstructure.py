...
from quantum_edge_core.events import MarketTrade, OrderBookUpdate, LargeBlockEvent, MicrostructureMetrics
...
class MicrostructureAnalyzer:
    ...
    def process_book(self, update: OrderBookUpdate) -> Optional[MicrostructureMetrics]:
        ...
        return MicrostructureMetrics(
            symbol=update.symbol, imbalance=imbalance, spread_bps=spread_bps, timestamp=update.timestamp
        )
