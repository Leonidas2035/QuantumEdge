...
from hermes.supervisor.config import LockbotControlConfig
from hermes.supervisor.contracts.lockbot_control_v1 import (
    AckEnvelope,
    StatusEnvelope,
    build_command,
    validate_command,
)
from hermes.supervisor.contracts.lockbot_exec_v1 import (
    ExecEnvelope,
)
...
class LockbotControlClient:
    def __init__(
        ...
        self._pub.setsockopt(zmq.RCVTIMEO, 2000)
        self._pub.setsockopt(zmq.SNDTIMEO, 2000)
