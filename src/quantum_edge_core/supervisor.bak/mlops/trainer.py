...
from hermes.mlops.manifest import ModelManifest
from hermes.mlops.registry import sha256_file
from hermes.research.offline.signal_model.train import train_model
