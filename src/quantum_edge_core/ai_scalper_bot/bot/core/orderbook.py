...
class OrderBookCache:
    ...
    def update(self, tick: Dict[str, Any]) -> None:
        ...
        try:
            ...
            # Update History
            market_tick = MarketTick(price=price, quantity=qty, timestamp=ts, is_buyer_maker=is_maker)
    ...
    def get_snapshot(self) -> np.ndarray:
        ...
        # Extract data
        data = [[t.price, t.quantity, 1.0 if t.is_buyer_maker else 0.0] for t in self._history]
