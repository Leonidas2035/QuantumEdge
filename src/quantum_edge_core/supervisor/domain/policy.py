...
from quantum_edge_core.supervisor.domain.models import PolicyContract, RiskVerdict, RiskLevel, TradingMode
...
class PolicyManager:
    ...
    def enforce_hard_risk(self, verdict: RiskVerdict, policy: PolicyContract) -> PolicyContract:
        """
