...
class ContextBuilder:
    ...
    def _build_sentiment_context(self) -> Dict[str, Any]:
        ...
        return {"funding": funding, "oi_change": metrics.get("oi_change", 0.0), "funding_pressure": pressure}
    ...
    def _build_risk_context(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "leverage": total_exposure / 10000.0 if total_exposure > 0 else 0.0,  # Mock Equity
        }
