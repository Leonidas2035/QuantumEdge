...
with tab2:
    ...
    df_llm, is_llm_mock = fetch_data("SELECT * FROM llm_advice ORDER BY time DESC LIMIT -50", get_mock_llm_advice)
...
with tab5:
    ...
    df_ob, is_ob_mock = fetch_data("SELECT * FROM orderbook_snapshots ORDER BY timestamp DESC LIMIT -1000", get_mock_orderbook)
