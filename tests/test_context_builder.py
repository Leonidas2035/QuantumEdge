...
from hermes.supervisor.data_ingest import DataStore
from hermes.supervisor.context_builder import ContextBuilder
...
class TestContextBuilder(unittest.TestCase):
    ...
    def test_update_futures_position(self):
        ...
        # Update
        self.store.update_futures_position(
            "BTCUSDT", {"positionAmt": 0.5, "entryPrice": 50000.0}
        )
        # Delta
    ...
    def test_build_snapshot_completeness(self):
        ...
        self.store.update_futures_position(
            "BTCUSDT",
            {"positionAmt": 1.0, "entryPrice": 50000.0, "unrealizedProfit": 500.0},
        )
