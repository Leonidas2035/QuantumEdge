...
from quantum_edge_core.supervisor.supervisor.policy.circuit_breaker import CircuitBreaker
from quantum_edge_core.supervisor.supervisor.policy.heuristics import HeuristicDecision, HeuristicThresholds, apply_heuristics
from quantum_edge_core.supervisor.supervisor.policy.policy_engine import PolicyEngine, PolicyEngineConfig, HysteresisConfig, PolicyHysteresis
from quantum_edge_core.supervisor.supervisor.policy.signals import Signals
...
def test_llm_failure_falls_back(monkeypatch, tmp_path: Path):
    ...
    from quantum_edge_core.supervisor.supervisor.policy import policy_engine as policy_engine_module
