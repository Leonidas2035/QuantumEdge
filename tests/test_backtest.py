...
class TestBacktestEngine(unittest.TestCase):
    ...
    def test_full_backtest_loop(self, MockLoader):
        ...
        for i in range(20):
            ...
            events.append({"timestamp": ts, "price": price, "quantity": 1.0, "side": "SELL", "type": "trade"})
        ...
        # Run
        runner = BacktestRunner(symbol="BTCUSDT", start_time=datetime(2025, 1, 1), end_time=datetime(2025, 1, 2))
